...
public class ScienceActivity extends AppCompatActivity {
    ...
    public static final String category = "science";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layoutManager = new LinearLayoutManager(ScienceActivity.this);
        ...
        call.enqueue(new Callback<News>() {
            ...
            public void onResponse(Call<News> call, Response<News> response){
                if (response.isSuccessful() && response.body().getArticle() != null) {
                    ...
                    adapter = new Adapter(articles, ScienceActivity.this);
                    ...
                    Toast.makeText(ScienceActivity.this, "No Result", Toast.LENGTH_SHORT).show();
                }
            }
